...
from data_utils.eval import evaluate_for_file
...
def main():
    ...
    parser.add_argument("--medical_word_path", type=str, default='data/data_for_pretrain/all_data/medical_words_list.txt',
